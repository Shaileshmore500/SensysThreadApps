...
function image(type)
{
  //debugger;
  if(type=='warning'){
    return "http://localhost:3850/Apps/App_DIP/10029068931678642557-512.png"
  }
  else if(type=='success'){
    return "http://localhost:3850/Apps/App_DIP/Q9BGTuy.png";
  }
  else if(type=='error'){
    return "http://localhost:3850/Apps/App_DIP/GnyDvKN.png";
  }
  else if(type=='info')
  {
    return "http://localhost:3850/Apps/App_DIP/12151627261617256522-512.png"
  }
}
