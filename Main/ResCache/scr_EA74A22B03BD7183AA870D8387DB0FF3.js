...
Erp.FieldInfo.push({Name:"tbl_va_employeeinformation_campusemailid",ID:"html_campusEmail",Disabled:true,Type:"Text",DataType:"EMAIL",CustomRender:false,Mandatory:false,IsDescriptive:false,ReqForCalc:false,Data:null,OnValid:(typeof html_campusEmail_Valid=='function'?html_campusEmail_Valid:null)});
...
chk_emailnotavailable_Change();
  ...
  {
  Erp.SetEnable("html_campusEmail",true);
  }
  else
  {
  Erp.SetEnable("html_campusEmail",false);
  }
}
/****************************************************************************************************************/
