...
Erp.FieldInfo.push({Name:"tbl_va_employeeinformation_fresher",ID:"chk_fresher",Disabled:false,Type:"Bool",DataType:"CHECKBOX",CustomRender:false,Mandatory:false,IsDescriptive:false,ReqForCalc:false,Data:null});
__erp_fn_8($('#chk_experience'),chk_experience_Change);
Erp.FieldInfo.push({Name:"tbl_va_employeeinformation_employeeexperience",ID:"chk_experience",Disabled:false,Type:"Bool",DataType:"CHECKBOX",CustomRender:false,Mandatory:false,IsDescriptive:false,ReqForCalc:false,Data:null,OnLoad:(typeof chk_experience_Load=='function'?chk_experience_Load:null),OnValid:(typeof chk_experience_Valid=='function'?chk_experience_Valid:null)});
...
Erp.FieldInfo.push({Name:"tbl_va_employeeinformation_fixedsalary",ID:"html_monthlysal",Disabled:false,Type:"Number",DataType:"DECIMAL",CustomRender:false,Mandatory:true,IsDescriptive:false,ReqForCalc:false,Data:null,OnValid:(typeof html_monthlysal_Valid2=='function'?html_monthlysal_Valid2:null)});
window.__erp_fn_10= function (el,onChange){
el.autoNumeric('init',{vMin:'-79228162514264337593543950335',vMax:'79228162514264337593543950335', mDec :50,aSep :'',dGroup:0,aPad:false,pSign: 'p'});

}
__erp_fn_10($('#html_lastmonthsal'));
Erp.FieldInfo.push({Name:"tbl_va_employeeinformation_lastdrawnmonthlysalary",ID:"html_lastmonthsal",Disabled:false,Type:"Number",DataType:"DECIMAL",CustomRender:false,Mandatory:false,IsDescriptive:false,ReqForCalc:false,Data:null});
__erp_fn_10($('#html_ToatalWorkExp'));
Erp.FieldInfo.push({Name:"tbl_va_employeeinformation_totalworkexperience",ID:"html_ToatalWorkExp",Disabled:false,Type:"Number",DataType:"DECIMAL",CustomRender:false,Mandatory:true,IsDescriptive:false,ReqForCalc:false,Data:null,OnValid:(typeof html_ToatalWorkExp_Valid=='function'?html_ToatalWorkExp_Valid:null)});
__erp_fn_0($('#date_scheduledate'));
Erp.FieldInfo.push({Name:"tbl_va_employeeinformation_scheduledate",ID:"date_scheduledate",Disabled:false,Type:"Date",DataType:"DATE",CustomRender:false,Mandatory:false,IsDescriptive:false,ReqForCalc:false,Data:null,OnValid:(typeof date_scheduledate_Valid=='function'?date_scheduledate_Valid:null)});
...
Erp.FieldInfo.push({Name:"tbl_va_employeeinformation_employeeothermaster5_fid",ID:"html_StaffOrientation",Disabled:false,Type:"Ddl",DataType:"SINGLESELECT_TABLE",CustomRender:false,Mandatory:true,IsDescriptive:false,ReqForCalc:false,Data:null});
