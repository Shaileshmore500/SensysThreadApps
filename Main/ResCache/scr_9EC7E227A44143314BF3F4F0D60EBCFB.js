...
DbReferences.push({Type:"Simple",Id:"db_fld_0",Columns:"field.firstname",AlwaysLoad:true});window.db_fld_0='';
DbReferences.push({Type:"Simple",Id:"db_fld_1",Columns:"field.firstname",AlwaysLoad:true});window.db_fld_1='';
DbReferences.push({Type:"Simple",Id:"db_fld_2",Columns:"user.userfullname",AlwaysLoad:false});window.db_fld_2='';
DbReferences.push({Type:"Simple",Id:"db_fld_3",Columns:"user.users_pid",AlwaysLoad:false});window.db_fld_3='';

FunctionList.push({Name:'LoadFunction',Refs:['db_fld_0']});
FunctionList.push({Name:'',Refs:['db_fld_0']});
FunctionList.push({Name:'',Refs:['db_fld_2','db_fld_3']});
...
function LoadFunction(){
  ...
  if($('._modal'))
  {
    $('._modal ._sectionOne h6').html(`Dear ${db_fld_0}
,
Before we get started we need to have your identity verified, please proceed to begin with your verification process by clicking the button below.`)
  ...
  $('#lbl_welcomemsg').html("Hello "+db_fld_0+" ! Welcome to the team! We're happy to have you on board as you go through the<br> verification process. If you have any questions or need assistance, feel free to reach out. Looking forward to working <br>together and achieving success!");
    ...
    if(Fn.IsEmpty(EmployeeID) && Erp.LayoutMode=="A" && Fn.GetProp('mode') == 'principle')
    {
      ...
      if(Fn.IsEmpty(Aadhar))
        ...
        if(Fn.IsEmpty(Pan))
          ...
          //Erp.SetFieldValue('html_hiredby',db_fld_2);
          Erp.SetFieldValue('Select23',db_fld_3);
    }
