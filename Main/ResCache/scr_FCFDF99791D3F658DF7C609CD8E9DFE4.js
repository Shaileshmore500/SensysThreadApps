...
Erp.FieldInfo.push({Name:"_html_app_remark",ID:"html_app_remark",Disabled:false,Type:"Text",DataType:"TEXT",CustomRender:false,Mandatory:false,IsDescriptive:false,ReqForCalc:false,Data:null});
$('#btn_accept').on('click',function(){onFieldChange(btn_submitWorkFlow,$(this));});
$('#btn_reject').on('click',function(){onFieldChange(btn_submitWorkFlow,$(this));});
...
var ddl=el;ddl.parent().addClass('ui-list');ddl.data('InlineMode',true);ddl.data('FieldID','uid_12');ddl.data('LookupCode','');ddl.data('Eids','tbl_VA_relationmaster');ddl.data('FieldType','SINGLESELECT_TABLE');ddl.data('Multi',false);enableKeyboardForList(ddl);ddl.parent().on('click',function(){showSearchList($(this));});
...
var ddl=el;ddl.parent().addClass('ui-list');ddl.data('InlineMode',true);ddl.data('FieldID','uid_43');ddl.data('LookupCode','');ddl.data('Eids','tbl_VA_reasonmaster');ddl.data('FieldType','SINGLESELECT_TABLE');ddl.data('Multi',false);enableKeyboardForList(ddl);ddl.parent().on('click',function(){showSearchList($(this));});
...
var ddl=el;ddl.parent().addClass('ui-list');ddl.data('InlineMode',true);ddl.data('FieldID','uid_69');ddl.data('LookupCode','');ddl.data('Eids','tbl_VA_degreemaster');ddl.data('FieldType','SINGLESELECT_TABLE');ddl.data('Multi',false);enableKeyboardForList(ddl);ddl.parent().on('click',function(){showSearchList($(this));});
