<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Meta/MetaMain.Master" CodeBehind="FieldPermission_View.aspx.cs" Inherits="SensysErp.Meta.FieldPermission_View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenWindow(mode) {
            var text = "";
            if (mode == "A")
                text = "Add Field Permission"
            else if (mode == "E")
                text = "Edit Field Permission";
            else if (mode == "D")
                text = "Delete";
            else {
                mode = "V";
                text = "View Field Permission ";
            }
            var newurl = "";
            if (mode == "A") {
                window.open("../main/view.aspx?EID=tbl_SYS_Config&_fc=FieldPermissions_Add&_pt=V&PageType=A");
            }
                ...
                window.open("../main/view.aspx?EID=tbl_SYS_Config&_fc=FieldPermissions_Add&_pt=V&PageType=" + mode + "&ID=" + id);
            }
        return false;
        }
