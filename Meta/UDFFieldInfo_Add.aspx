<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Meta/MetaMain.Master" CodeBehind="UDFFieldInfo_Add.aspx.cs" Inherits="SensysErp.Meta.UDFFieldInfo_Add" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div>
                                ...
                                <div class="div-form" style="width: initial; background-color: transparent; background-image: none">
                                    <table class="fieldinfo table-form">
                                        <tr>
                                            <td class="td-label">
                                                <asp:Label ID="lblUDFFieldType" runat="server" Text="Field Type"></asp:Label>
                                            </td>
                                            <td class="td-value">
                                               <telerik:RadComboBox Width="205px" ID="rcbUDFFieldType" runat="server" OnClientSelectedIndexChanged="OnFieldChanged">
                                                    <Items>
                                                        ...
                                                        <telerik:RadComboBoxItem Text="Multi-Lines" Value="Multiline" />
                                                        ...
                                                        <telerik:RadComboBoxItem Text="Calculated" Value="Calculated" />
                                                        <telerik:RadComboBoxItem Text="Date" Value="Date" />
                                                        <telerik:RadComboBoxItem Text="Time" Value="Time" />
                                                        <telerik:RadComboBoxItem Text="Date-Time" Value="Datetime" />
                                                        <telerik:RadComboBoxItem Text="Image" Value="Image" />
                                                        <telerik:RadComboBoxItem Text="Documents" Value="Documents" />
                                                        <telerik:RadComboBoxItem Text="Single-Select" Value="SingleSelect" />
                                                        <telerik:RadComboBoxItem Text="Multi-Select" Value="MultiSelect" />
                                                        <telerik:RadComboBoxItem Text="Mixed-Select" Value="MixedSelect" />
                                                        <telerik:RadComboBoxItem Text="Mixed-Multi-Select" Value="MixedMultiSelect" />
                                                    </Items>
                                                </telerik:RadComboBox>
                                            </td>
                                        </tr>
                                ...
                                <div class="div-form" style="width: initial; background-color: transparent; background-image: none">
                                    <table id="tblFieldInfo" class="fieldinfo table-form">
                                        <%--<tr id="trType" runat="server">
                                            ...
                                            <td class="td-value">
                                                <telerik:RadComboBox ID="rcbFieldType" runat="server" AutoPostBack="true" Width="200px" ></telerik:RadComboBox>
                                            </td>
                                        </tr>--%>
                                        ...
                                        <tr id="trPass" runat="server">
                                            <td></td>
                                            <td class="td-value">
                                                <asp:CheckBox ID="chkPasswordEncrypt" Visible="false" CssClass="chkX td-label" runat="server"  TextAlign="Left" Text="Encrypt this field." />
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="trSingleChk" runat="server">
                                        ...
                                        <tr id="trImageFileSize" runat="server" >
                                            <td class="td-label">
                                        ...
                                        <tr id="trImageFileType" runat="server">
                                            <td class="td-label">
                                         ...
                                         <tr id="trImageEnableFilesteam" runat="server" >
    ...
    <script type="text/javascript">
        ...
        function pageLoad() {
            ...
            $('#<%=divBasic.ClientID%>> div').accordion({ heightStyle: "content", collapsible: true });
           
            $('#<%=chkPrefill.ClientID%>,#<%=chkAllowMod.ClientID%>,#<%=chkDeactivate.ClientID%>,#<%=chkPasswordEncrypt.ClientID%>,#<%=chkEnableFileStream.ClientID%>').CheckBoxX()
        ...
        function selectEntity(sender, args) {
            ...
            var fldtype = $find("<%= rcbUDFFieldType.ClientID %>").get_value();
...
function PageValidation() {
    ...
    fldType = ($find("<%=rcbUDFFieldType.ClientID%>") ? $find("<%=rcbUDFFieldType.ClientID%>").get_selectedItem().get_value() : $.QS("FieldType"));
...
function tvItems_NodePopulate(sender, args) {
    ...
    if (dtype.get_value().toLowerCase() == "decimal" ||
...
function rcbRounding_OnClientSelectedIndexChanged(sender, args) {
    ...
    if (rnd != undefined || rnd != null) {
        ...
        $('#<%=rcbRoundingType.ClientID%>').setDisplay(false); 
        if (rnd.get_selectedItem() != null) {
            ...
            $('#<%=rcbRoundingType.ClientID%>').setDisplay(true); 
        }
    }
}
...
function tvSettings_NodeClick(sender, args) {
    ...
    if (aSettingMode == "round") {
        ...
        function toggleEntityTree(txt) {
            ...
            if (fldtype.toLowerCase() != "mixedselect" && fldtype.toLowerCase() != "mixedmultiselect") {
                $("#<%= tvEntity.ClientID %>").find(".rtChk").find("input").hide();
                $("#tvCtrEnt").find(".rtChk").find("input").hide();
                $("#tvCtrEnt").find(".rtChk").hide();
                
            }
            else {
                $("#<%= tvEntity.ClientID %>").find(".rtChk").find("input").show();
                $("#tvCtrEnt").find(".rtChk").find("input").show();
                $("#tvCtrEnt").find(".rtChk").show();
            }
            $("#tvCtrEnt").setDisplay(true);
        }
        ...
        function ShowSourceOption() {
            var rcb = $find("<%= rcbMultiSourceOption.ClientID %>");
              var val = "";
              $('#<%=trSingleChk.ClientID%>').setDisplay(false);
            ...
            if (val == "table") {
                $('#<%=pnlSrcTbl0.ClientID%>').setDisplay(true);
                $('#<%=pnlDis.ClientID%>').setDisplay(true); 
                $('#<%=pnlArray1.ClientID%>').setDisplay(false);
                
                
            }
            else if (val == "array") {
                $('#<%=pnlSrcTbl0.ClientID%>').setDisplay(false);
                $('#<%=pnlDis.ClientID%>').setDisplay(false);
                $('#<%=pnlArray1.ClientID%>').setDisplay(true);
               
                
                $('#<%=trSingleChk.ClientID%>').setDisplay(true);
            }
        ...
        function ToggleControls() {
            ...
            $('#<%=trMask.ClientID%>').setDisplay(false);
            $('#<%=trPass.ClientID%>').setDisplay(false);
            $('#<%=trSpecified.ClientID%>').setDisplay(false);
            $('#<%=trDynamic0.ClientID%>').setDisplay(false);
            $('#<%=trRounding0.ClientID%>').setDisplay(false);
            $('#<%=fldLenght.ClientID%>').setDisplay(false);
            $('#<%=trCriteria.ClientID%>').setDisplay(false);
            $('#<%=trCurrency.ClientID%>').setDisplay(false);
            $('#<%=trCalculate.ClientID%>').setDisplay(false);
            $('#<%=trChkYes.ClientID%>').setDisplay(false);
            $('#<%=trChkNo.ClientID%>').setDisplay(false);
            $('#<%=MultiOption.ClientID%>').setDisplay(false);
            $('#<%=RenderOption.ClientID%>').setDisplay(false);
            $('#<%=pnlSrcTbl0.ClientID%>').setDisplay(false);
            $('#<%=pnlSrcTbl1.ClientID%>').setDisplay(false);
            $('#<%=pnlDis.ClientID%>').setDisplay(false);
            $('#<%=pnlArray1.ClientID%>').setDisplay(false);
            $('#<%=pnlPredef.ClientID%>').setDisplay(false);
            $('#<%=trDynamic1.ClientID%>').setDisplay(false);
            $('#<%=trDynamic2.ClientID%>').setDisplay(false);
            $('#<%=trImageFileSize.ClientID%>').setDisplay(false);
            $('#<%=trImageFileType.ClientID%>').setDisplay(false); 
            $('#<%=trImageEnableFilesteam.ClientID%>').setDisplay(false);
            $('#<%=trSingleChk.ClientID%>').setDisplay(false);
            $("#divFieldInfo").hide();
            
        } 

        function OnFieldChanged(sender, args) {

            ToggleControls();
            var fldtype = "";
            if (sender == undefined)
             fldtype = $find("<%= rcbUDFFieldType.ClientID %>").get_value();
            else
             fldtype = sender.get_value();
            ...
            if (fldtype == "Text"
                ...
                || fldtype == "Documents"
                || fldtype == "Checkbox"
                 || fldtype == "SingleSelect"
                 || fldtype == "MultiSelect"
                 || fldtype == "MixedSelect"
                 || fldtype == "MixedMultiSelect"
                ) {
                $("#divFieldInfo").show();
            }
            
            if (fldtype == "Text") {
                $('#<%=trMask.ClientID%>').setDisplay(true);
                $('#<%=fldLenght.ClientID%>').setDisplay(true);
                if ($.QS("PageType") == "A")
                    $find("<%= ntxtFldLength.ClientID %>").set_value(50);
            }
            else if (fldtype == "Password") {
                $('#<%=trMask.ClientID%>').setDisplay(true);
                    $('#<%=trPass.ClientID%>').setDisplay(true);
                }
            ...
            else if (fldtype == "Multiline") {
                $('#<%=trSpecified.ClientID%>').setDisplay(true);
                $('#<%=fldLenght.ClientID%>').setDisplay(true);
                if ($.QS("PageType") == "A")
                    $find("<%= ntxtFldLength.ClientID %>").set_value(250);
            }
            else if (fldtype == "Decimal") {
                $('#<%=trRounding0.ClientID%>').setDisplay(true);
                $('#<%=rcbRoundingType.ClientID%>').setDisplay(false); 
                $('#<%=txtRoundingSettings.ClientID%>').setDisplay(false);
                rcbRounding_OnClientSelectedIndexChanged();
            }
            else if (fldtype == "Currency") {
                $('#<%=trRounding0.ClientID%>').setDisplay(true); 
                $('#<%=trCurrency.ClientID%>').setDisplay(true);

                $('#<%=rcbRoundingType.ClientID%>').setDisplay(false);
                $('#<%=txtRoundingSettings.ClientID%>').setDisplay(false); 
                $('#<%=txtCurrencySetting.ClientID%>').setDisplay(false);
                rcbRounding_OnClientSelectedIndexChanged();
            ...
            else if (fldtype == "Calculated") {
                $('#<%=trRounding0.ClientID%>').setDisplay(true);
                $('#<%=trCalculate.ClientID%>').setDisplay(true);
                $('#<%=pnlSrcTbl0.ClientID%>').setDisplay(true);
                $('#<%=pnlSrcTbl1.ClientID%>').setDisplay(true);

                $('#<%=rcbRoundingType.ClientID%>').setDisplay(false);
                $('#<%=txtRoundingSettings.ClientID%>').setDisplay(false);
                $('#<%=txtMixEntity.ClientID%>').setDisplay(false);
                $('#btnRecordFilter').hide();
                rcbRounding_OnClientSelectedIndexChanged();
                
            }
            else if (fldtype == "Checkbox") {
                $('#<%=trChkYes.ClientID%>').setDisplay(true);
                $('#<%=trChkNo.ClientID%>').setDisplay(true);
            }
            else if (fldtype == "Image") {
                $('#<%=trImageFileSize.ClientID%>').setDisplay(true);
                $('#<%=trImageFileType.ClientID%>').setDisplay(true);
                $('#<%=trImageEnableFilesteam.ClientID%>').setDisplay(true);
                if ($.QS("PageType") == "A") {
                    $('#<%=txtFileTypes.ClientID%>').val("bmp,dib,eps,gif,img,jpe,jpg,jpeg,mac,pcx,pct,ppm,psd,pcd,png,ras,tga,tif,tiff,wmf");
                }
            }
            else if (fldtype == "Documents") {
                $('#<%=trImageFileSize.ClientID%>').setDisplay(true);
                $('#<%=trImageFileType.ClientID%>').setDisplay(true);
                $('#<%=trImageEnableFilesteam.ClientID%>').setDisplay(true);

                if ($.QS("PageType") == "A") 
                    $('#<%=txtFileTypes.ClientID%>').val("");
            }
            else if (fldtype == "SingleSelect") {
                $('#<%=MultiOption.ClientID%>').setDisplay(true);
                $('#<%=pnlSrcTbl0.ClientID%>').setDisplay(true);
                $('#<%=pnlDis.ClientID%>').setDisplay(true);

                $('#<%=txtEntity.ClientID%>').setDisplay(true);
                $('#<%=txtMixEntity.ClientID%>').setDisplay(false);
                ShowSourceOption();
            }
            ...
            else if (fldtype == "MixedSelect") {
                $('#<%=pnlSrcTbl0.ClientID%>').setDisplay(true);
                $('#btnRecordFilter').hide();

                $('#<%=txtEntity.ClientID%>').setDisplay(false);
                $('#<%=txtMixEntity.ClientID%>').setDisplay(true);
            }
            else if (fldtype == "MixedMultiSelect") {
                $('#<%=pnlSrcTbl0.ClientID%>').setDisplay(true);
                $('#btnRecordFilter').hide();
                $('#<%=txtEntity.ClientID%>').setDisplay(false);
                $('#<%=txtMixEntity.ClientID%>').setDisplay(true);
