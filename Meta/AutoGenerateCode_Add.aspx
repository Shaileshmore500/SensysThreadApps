...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <table class="table-form">
                    ...
                    <tr id="trResetNumber">
                        ...
                        <td class="td-value">
                            ...
                            <label title="To be used if numbering needs to be reset on year or month change" style="margin-left: 15px; vertical-align: middle" for="chkPrefixChange">Reset On Prefix Date Change</label><input style="margin-left: 3px; vertical-align: middle" id="chkPrefixChange" type="checkbox" />
                            <label title="To be used if numbering needs to be reset on year or month change" style="margin-left: 15px; vertical-align: middle" for="chkSuffixChange">Reset On Suffix Date Change</label><input style="margin-left: 3px; vertical-align: middle" id="chkSuffixChange" type="checkbox" />
                        </td>
                    </tr>
                    <tr>
    ...
    <script type="text/javascript">
        ...
        function LaunchCriteriaCode(ctl) {
            ...
            if (currentCodeDiv.val() != "") {
                ...
                $("#chkPrefixChange,#chkSuffixChange,#chkDoNotReset").checked(false);
                toggleReset();
    ...
    var sfx = $find("<%= edSuffix.ClientID %>").get_value();
        ...
        $(function () {
            $('#<%=chkPrefill.ClientID%>,#<%=chkAllowMod.ClientID%>,#chkDoNotReset').CheckBoxX()
        });
