                                ...
                                <Nodes>
                                    <telerik:RadTreeNode SS="0" Value="Agg" Text="Aggregates" Prefix="Fn">
                                        <Nodes>
                                            ...
                                            <telerik:RadTreeNode Value="Sort(TABLE,function(){})" Text="Sort" Info="Desc:Sort an array of items by the given expression.|Eg:Fn.Sort( [ {a:1,b:2,c:3} , {a:4,b:5,c:6} , {a:7,b:8,c:9} ] , 'b desc')|Result:[ {a:7,b:8,c:9}, {a:4,b:5,c:6} , {a:1,b:2,c:3} ]<br/>[]">
                                            </telerik:RadTreeNode>
                                        </Nodes>
                                    </telerik:RadTreeNode>
                                    ...
                                    <telerik:RadTreeNode SS="0" Value="InterfaceFunctions" Text="Interface Functions">
                                        <Nodes>
                                                ...
                                                <Nodes>
                                                            ...
                                                            <telerik:RadTreeNode Value="Erp.Grid.OnRecordSaving(grid,GridRecordSaving);\nfunction GridRecordSaving(gridId,args){\n\n}\n" NoWF="1" Text="OnRecordSaving" Info="Desc:Triggers when a row data is being read for saving. If this function returns false then the entire save operation will be cancelled.If this function returns null then the current record will not be saved.|Eg:Erp.Grid.OnRecordSaving('Grid-1',function(gridId,args){<br/>//args.entityId<br/>//args.entity -- the Erp.Entity object to be saved<br/>//args.entityList -- the list of Erp.Entity that is going to be saved.<br/>//args.row -- the current grid row which is being saved<br/>});">
                                                             ...
                                                             <telerik:RadTreeNode Value="Erp.Grid.OnSaveComplete(grid,GridSaveComplete);\nfunction GridSaveComplete(gridId,args){\n\n}\n" NoWF="1" Text="OnSaveComplete" Info="Desc:Triggers after all changes are saved in the database.|Eg:Erp.Grid.OnSaveComplete('Grid-1',function(gridId,args){<br/>//args.entityId<br/>//args.result -- the result of the save operation.<br/>});">
                                                               ...
                                                               <telerik:RadTreeNode Value="Erp.Grid.OnGridBinding(grid,GridBinding);\nfunction GridBinding(gridId,args){\n\n}\n" NoWF="1" Text="OnGridBinding" Info="Desc:Triggers when a grid is being databound or filtered or sorted. If method returns false then action is cancelled. If method returns an array then the array is bound to the grid|Eg:Erp.Grid.OnGridBinding('Grid-1',function(gridId,result){<br/>//args.entityId<br/>//args.action -- BindGrid/Filter/Sort/SearchText<br/>//args.gridTextFilter//args.gridData<br/>//args.gridFilter<br/>//args.gridSort<br/>});">
                                                            </telerik:RadTreeNode>
                                                             ...
                                                             <telerik:RadTreeNode Value="Erp.Grid.OnGridExporting(grid,GridExporting);\nfunction GridExporting(gridId, format, colInfo, settings){\n\n}\n" NoWF="1" Text="OnGridExporting" Info="Desc:Triggers when data is being exported from grid. If function returns false then exporting is cancelled|Eg:Erp.Grid.OnGridExporting('Grid1',function(gridId, format, colInfo, settings){<br/>//colInfo.FieldName<br/>//colInfo.HeaderText<br/>//colInfo.FooterText<br/>//colInfo.Width<br/>//colInfo.Hidden<br/>//colInfo.HeaderStyle<br/>//colInfo.ItemStyle<br/>//colInfo.FooterStyle<br/>//colInfo.Formatting<br/>//colInfo.ExportCurrentPage<br/><br/>});">
                                                            </telerik:RadTreeNode>
                                                            <telerik:RadTreeNode Value="Erp.Grid.OnGridAdvancedFilter(grid,GridDataBound);\nfunction GridAdvancedFilter(gridId,result){\n\n}\n" NoWF="1" Text="OnGridAdvancedFilter" Info="Desc:Triggers after grid is filtered with advanced filter.|Eg:Erp.Grid.OnGridAdvancedFilter('Grid-1',function(gridId,result){<br/>});">
                                                            </telerik:RadTreeNode>
                                                            <telerik:RadTreeNode Value="Erp.Grid.OnGridButtonClick(grid,GridButtonClick);\nfunction GridButtonClick(gridId,btn,action){\n\n}\n" NoWF="1" Text="OnGridButtonClick" Info="Desc:Triggers when a button in the grid is clicked.If function returns false then action is cancelled|Eg:Erp.Grid.OnGridButtonClick('Grid-1',function(gridId,btn,action){<br/>});">
                                                            </telerik:RadTreeNode>
                                                         </Nodes>                                                    
                                            </telerik:RadTreeNode>
                                            <telerik:RadTreeNode Value="" NoWF="1" Text="Repeater" Info="Desc:Repeater Related Functions">
                                                <Nodes>
                                                    <telerik:RadTreeNode Value="Erp.Repeater.Databind(repeaterId, data)" NoWF="1" Text="Databind" Info="Desc:Binds data to the Repeater |Eg:Erp.Repeater.Databind('Repeater-1',[{col1:'a',col2:'b'},{col1:'c',col2:'d'}]);<br/>Erp.Repeater.Databind('Repeater-1','tblRecords');<br/>Erp.Repeater.Databind('Repeater-1','tblRecords','first,last,next,prev,5');<br/>Erp.Repeater.Databind('Repeater-1','tblRecords',parentToken,'first,last,next,prev,5');|Result:Repeater is bound to an array<br/>Repeater is bound to a table variable(Repeater will internally call Erp.LoadVariable)<br/>Paging commands can be provided in the third parameter<br/>data is bound to the Child repeater for the specified parent token">
                                                    </telerik:RadTreeNode>                                                    
                                                    ...
                                                    <telerik:RadTreeNode Value="Erp.Repeater.DeleteItem(token,deleteImmediately)" NoWF="1" Text="DeleteItem" Info="Desc:Deletes item from the repeater for the specified token |Eg:Erp.Repeater.DeleteItem('tk-1');<br/>Erp.Repeater.DeleteItem(['tk-1','tk-2']);<br/>Erp.Repeater.DeleteItem(['tk-1','tk-2'],true);|Result:The record will be deleted from the repeater.Database changes will be done when Erp.Repeater.SaveChanges is called<br/The array of records will be deleted from the repeater.Database changes will be done when Erp.Repeater.SaveChanges is called<br/>The array of records will be deleted from the repeater also data will be deleted from database immediately">
                                                     ...
                                                     <telerik:RadTreeNode Value="Erp.Repeater.ClearItems(repeaterId)" NoWF="1" Text="ClearItems" Info="Desc:Clears all items in the repeater. No database operation will be performed. |Eg:Erp.Repeater.ClearItems('Repeater-1');<br/>Erp.Repeater.ClearItems('ChildRepeater-1','tk-1');<br/>|Result:All items will be removed from specified repeater.<br/>All child items will be deleted for specified parent token ">
                                                    </telerik:RadTreeNode>
                                                    ...
                                                    <telerik:RadTreeNode Value="Erp.Repeater.GetNextToken(token)" NoWF="1" Text="GetNextToken" Info="Desc:Retrieves the next token for specified token">
                                                    </telerik:RadTreeNode>
                                                    <telerik:RadTreeNode Value="Erp.Repeater.GetPrevToken(token)" NoWF="1" Text="GetPrevToken" Info="Desc:Retrieves the previous token for specified token">
                                                    </telerik:RadTreeNode>
                                                    ...
                                                    <telerik:RadTreeNode Value="Erp.Repeater.GetItemCount(repeaterId, token)" NoWF="1" Text="GetItemCount" Info="Desc:Returns the count of child html elements for the specified parent token and nested repeater id">
                                                     ...
                                                     <telerik:RadTreeNode Value="Erp.Repeater.GetPagerInfo(repeaterId)" NoWF="1" Text="GetPagerInfo" Info="Desc:Retrieves the pager information for the repeater|Eg:Erp.Repeater.GetPagerInfo('rpt1')<br/>Erp.Repeater.GetPagerInfo('rptChild',parentToken);">
                                                    </telerik:RadTreeNode>
                                                     <telerik:RadTreeNode Value="Erp.Repeater.ApplyPageCommand(repeaterId, command)" NoWF="1" Text="ApplyPageCommand" Info="Desc:This method is used for implementing custom paging. It sets the page number of the repeater according to the specified command and returns the page index |Eg:var pg = Erp.Repeater.ApplyPageCommand('Repeater-1','first,last,next,prev,5');<br/>Erp.Repeater.ApplyPageCommand('rptChild','first,last,next,prev,5',parentToken);">
                                                    </telerik:RadTreeNode>
                                                    <telerik:RadTreeNode Value="Erp.Repeater.SaveChanges(['repeater1','repeater2'])" NoWF="1" Text="SaveChanges" Info="Desc:Updates the database with any modified or created records">
                                                    </telerik:RadTreeNode>
                                             ...
                                             <telerik:RadTreeNode Value="" NoWF="1" Text="Repeater Events" Info="Desc:Various events that are triggered on a Repeater.">
                                                <Nodes>
                                                    ...
                                                    <telerik:RadTreeNode Value="Erp.Repeater.OnSaveComplete(repeaterId,RepeaterSaveComplete);\nfunction RepeaterSaveComplete(repeaterId,args){\n\n}\n" NoWF="1" Text="OnSaveComplete" Info="Desc:Triggers after all changes are saved in the database.|Eg:Erp.Repeater.OnSaveComplete('Repeater-1',function(repeaterId,args){<br/>//args.info -- repeater information<br/>//args.result -- the result of the save operation.<br/>});">
                                                     ...
                                                     <telerik:RadTreeNode Value="Erp.Repeater.OnRepeaterDataBound(repeaterId,RepeaterDataBound);\nfunction RepeaterDataBound(repeaterId,args){\n\n}\n" NoWF="1" Text="OnRepeaterDataBound" Info="Desc:Triggers after data is bound to the repeater.|Eg:Erp.Repeater.OnRepeaterDataBound('Repeater-1',function(repeaterId,args){<br/>//args.info -- repeater information<br/>//args.token -- token for the parent row if it is a nested item<br/>});">
                                                      </telerik:RadTreeNode>
                                                     <telerik:RadTreeNode Value="Erp.Repeater.OnRepeaterCommand(repeaterId,RepeaterCommand);\nfunction RepeaterCommand(repeaterId,args){\n\n}\n" NoWF="1" Text="OnRepeaterCommand" Info="Desc:Triggers on paging sorting or filtering.If method returns false command will be aborted. If method returns an array then repeater will be bound with that data|Eg:Erp.Repeater.OnRepeaterCommand('Repeater-1',function(repeaterId,args){<br/>return true;<br/>//args.command -- page/filter/sort<br/>//args.commandEl -- element that triggered the command<br/>//args.commandArgs -- data related to the command<br/>});">
                                                      </telerik:RadTreeNode>
                                                     <telerik:RadTreeNode Value="Erp.Repeater.OnParameterRequesting(repeaterId,ParameterRequesting);\nfunction ParameterRequesting(repeaterId,args){\n\n}\n" NoWF="1" Text="OnParameterRequesting" Info="Desc:Triggers when data is about to be fetched from database for the repeater datasource. Will only fire if datasource is not blank. You can return object with parameter data in this method|Eg:Erp.Repeater.OnParameterRequesting('Repeater-1',function(repeaterId,args){<br/>return {'@param':'abc','@id':'123'};<br/>//args.command -- parameter<br/>//args.parentToken -- parent token of the repeater<br/>//args.search -- value of search field<br/>});">
                                                      </telerik:RadTreeNode>
                                                    ...
                                                    <telerik:RadTreeNode Value="Erp.Repeater.OnItemDragBegin(repeaterId,ItemDragBegin);\nfunction ItemDragBegin(repeaterId,args){\n\n}\n" NoWF="1" Text="OnItemDragBegin" Info="Desc:Triggers when an item is started dragging. If this function returns false then dragging will not be initiated.If this function returns  a jquery element then that element will be displayed while dragging.In case of multiple items dragging have to be allowed then set the args.tokenList to array of tokens that will be dragged |Eg:Erp.Repeater.OnItemDragBegin('Repeater-1',function(repeaterId,args){<br/>//args.action-- Begin <br/>//args.fromRepeater -- the repeater from which the item is dragged<br/>//args.token -- the token of the item that is being dragged.<br/>//args.tokenList --value will be null. set it to array of tokens in case of multiple items have to be dragged/dropped<br/>});">
                                                    </telerik:RadTreeNode>
                                                    <telerik:RadTreeNode Value="Erp.Repeater.OnItemDragging(repeaterId,ItemDragging);\nfunction ItemDragging(repeaterId,args){\n\n}\n" NoWF="1" Text="OnItemDragging" Info="Desc:Triggers when an item is dragged over another item or another repeater. This event is triggered for the repeater over which the item is currently hovering. If this function returns false then the dropzone will not be displayed over the item/repeater. So the dragged item will not be able to be dropped there |Eg:Erp.Repeater.OnItemDragging('Repeater-1',function(repeaterId,args){<br/>//args.action-- Dragging <br/>//args.fromRepeater -- the repeater from which the item is dragged<br/>//args.token -- the token of the item that is being dragged.<br/>//args.toRepeater -- the repeater over which the item is being dragged.<br/>//args.refToken -- the token of the item over which the item is being dragged. value can be null if the toRepeater has no items<br/>//args.tokenList -- array of tokens in case of multiple items are dragged/dropped<br/>//args.dropMode -- drop behavior can be changed to -  default (no change) / first (item will dropped at first position) / last (item will dropped at last position)<br/>});">
                                                    </telerik:RadTreeNode>
                                                    <telerik:RadTreeNode Value="Erp.Repeater.OnItemDropping(repeaterId,ItemDropping);\nfunction ItemDropping(repeaterId,args){\n\n}\n" NoWF="1" Text="OnItemDropping" Info="Desc:Triggers when the drag operation is completing and item is about to be dropped over another item or another repeater. This event is triggered for the repeater over which the item is dropping. If this function returns false then the item will not dropped to new location and the drag operation is considered as failed. If this method returns true then item will still not be dropped to new location but drag operation is considered successful. User have to implement their own logic for dropping|Eg:Erp.Repeater.OnItemDropping('Repeater-1',function(repeaterId,args){<br/>//args.action-- Dropping <br/>//args.fromRepeater -- the repeater from which the item was dragged<br/>//args.token -- the token of the item that was being dragged.<br/>//args.toRepeater -- the repeater over which the item was being dragged.<br/>//args.refToken -- the token of the item over which the item was being dragged. value can be null if the toRepeater has no items<br/>//args.tokenList -- array of tokens in case of multiple items are dragged/dropped<br/>//args.dropMode -- drop behavior - default/first/last<br/>});">
                                                    </telerik:RadTreeNode>
                                                     <telerik:RadTreeNode Value="Erp.Repeater.OnItemDropped(repeaterId,ItemDropped);\nfunction ItemDropped(repeaterId,args){\n\n}\n" NoWF="1" Text="OnItemDropped" Info="Desc:Triggers when the drag operation is completed and item is dropped over another item or another repeater. This event is triggered for the repeater over which the item was dropped. This event will not trigger in case if OnItemDropping event returned false |Eg:Erp.Repeater.OnItemDropped('Repeater-1',function(repeaterId,args){<br/>//args.action-- Dropped <br/>//args.fromRepeater -- the repeater from which the item was dragged<br/>//args.token -- the token of the item that was being dragged.<br/>//args.toRepeater -- the repeater over which the item was being dragged.<br/>//args.refToken -- the token of the item over which the item was being dragged. value can be null if the toRepeater has no items<br/>//args.tokenList -- array of tokens in case of multiple items are dragged/dropped<br/>//args.success -- whether the drag/drop operation was successful<br/>//args.handled -- whether the drop operation was handled by user<br/>//args.dropMode -- drop behavior - default/first/last<br/>});">
                                                    </telerik:RadTreeNode>
                                                      <telerik:RadTreeNode Value="Erp.Repeater.OnItemDragCompleted(repeaterId,ItemDragCompleted);\nfunction ItemDragCompleted(repeaterId,args){\n\n}\n" NoWF="1" Text="OnItemDragCompleted" Info="Desc:Triggers when the drag operation is completed . This event will always trigger even if the drag operation was not successful. This event is only triggered for the repeater from which the dragged item originally belongs. |Eg:Erp.Repeater.OnItemDragCompleted('Repeater-1',function(repeaterId,args){<br/>//args.action-- Completed <br/>//args.fromRepeater -- the repeater from which the item was dragged<br/>//args.token -- the token of the item that was being dragged.<br/>//args.toRepeater -- the repeater over which the item was being dragged.value can be null if drag operation was not successful<br/>//args.refToken -- the token of the item over which the item was being dragged. value can be null if the toRepeater has no items<br/>//args.tokenList -- array of tokens in case of multiple items are dragged/dropped<br/>//args.success -- whether the drag/drop operation was successful<br/>//args.handled -- whether the drop operation was handled by user<br/>//args.dropMode -- drop behavior - default/first/last<br/>});">
                                                    </telerik:RadTreeNode>
                                                </Nodes>                                                    
                                            </telerik:RadTreeNode>
                                            <telerik:RadTreeNode Value="" NoWF="1" Text="Document & Spreadheet" Info="Desc:Document & Spreadsheet Related Functions">
                                                <Nodes>
                                                    <telerik:RadTreeNode Value="" NoWF="1" Text="Document" Info="Desc:Document Related Functions">
                                                        <Nodes>
                                                             <telerik:RadTreeNode Value="Erp.Document.Load('Document1',{})" Text="Load" Info="Desc:Document is loaded into the editor|Eg:Erp.Document.Load('Document1');<br/>Erp.Document.Load('Document1', {Entity:'tbl_CORE_Company', Field:'Docs', RecordID:'123'});<br/>Erp.Document.Load('Document1', {FilePath:'%APPROOT%/documents/Doc123.docx'});<br/>Erp.Document.Load('Document1', {ResourceID:'123'});<br/>Erp.Document.Load('Document1', {Entity:'tbl_CORE_Company', Field:'Docs', RecordID:'123', DocName:'test.rtf', Format:'Rtf'});<br/>Erp.Document.Load('Document1', {Entity:'tbl_CORE_Company', Field:'Docs', RecordID:'123'}, function(args){alert('Loaded')});|Result:Document control is initialized to empty document<br/>Document stored in field Docs in Company table for Company Id 123 is loaded into the Editor<br/>A Document is loaded from specified file path<br/>A Document with resource ID 123 is loaded from Resources<br/>A Document is loaded into the editor with specified file name and format<br/>Document is loaded with specified settings and a callback function is executed on completion<br/>Available formats are Doc, Docx, Txt, Rtf, ePub, Html, Mht, Odt, Xml">
                                                            </telerik:RadTreeNode>
                                                            ...
                                                            <telerik:RadTreeNode Value="Erp.Document.OnDocumentSaving('Document1',DocumentSaving)\nfunction DocumentSaving(args){\n}\n" Text="OnDocumentSaving" Info="Desc:Event will be fired before document is saved.If function returns false then saving is aborted|Eg:Erp.Document.OnDocumentSaving('Document1',DocumentSaving)<br/>function DocumentSaving(args){<br/>return false;}<br/>">
                                                            </telerik:RadTreeNode>
                                                        </Nodes>
                                                    </telerik:RadTreeNode>
                                                    <telerik:RadTreeNode Value="" NoWF="1" Text="Pdf" Info="Desc:Pdf Related Functions">
                                                        <Nodes>
                                                             <telerik:RadTreeNode Value="Erp.Pdf.Load('test.pdf')" Text="Load"  Info='Desc:A PDF viewer is launched with specified settings|Eg:Erp.Pdf.Load("test.pdf");<br/>Erp.Pdf.Load({ { recordId: "123", entityId: "tbl_Core_company", field: "pdffield", path: "", page: 0, window: "window-1" } });'>
                                                            </telerik:RadTreeNode>
                                                    ...
                                                    <telerik:RadTreeNode Value="" NoWF="1" Text="Spread" Info="Desc:Spread Related Functions">
                                                        <Nodes>
                                                             <telerik:RadTreeNode Value="Erp.Spread.Load('Spread1',{})" Text="Load" Info="Desc:Document is loaded into the editor|Eg:Erp.Spread.Load('Spread1');<br/>Erp.Spread.Load('Spread1', {Entity:'tbl_CORE_Company', Field:'Docs', RecordID:'123'});<br/>Erp.Spread.Load('Spread1', {FilePath:'%APPROOT%/documents/spread123.xlsx'});<br/>Erp.Spread.Load('Spread1', {ResourceID:'123'});<br/>Erp.Spread.Load('Spread1', {Entity:'tbl_CORE_Company', Field:'Docs', RecordID:'123', DocName:'test.xls', Format:'Xls'});<br/>Erp.Spread.Load('Spread1', {Entity:'tbl_CORE_Company', Field:'Docs', RecordID:'123'}, function(args){alert('Loaded')});|Result:Spreadsheet is initialized to blank document<br/>Spreadsheet stored in field Docs in Company table for Company Id 123 is loaded into the Editor<br/>A Spreadsheet is loaded from specified file path<br/>A Spreadsheet with resource ID 123 is loaded from Resources<br/>A Spreadsheet is loaded into the editor with specified file name and format<br/>Spreadsheet is loaded with specified settings and a callback function is executed on completion<br/>Available formats are Xls, Xlsx, Csv, Xlsm, Xlt, Xltm, Xltx, Txt, Xml">
                                                            </telerik:RadTreeNode>
                                                            ...
                                                            <telerik:RadTreeNode Value="Erp.Spread.OnDocumentSaving('Document1',DocumentSaving)\nfunction DocumentSaving(args){\n}\n" Text="OnDocumentSaving" Info="Desc:Event will be fired before document is saved.If function returns false then saving is aborted|Eg:Erp.Spread.OnDocumentSaving('Document1',DocumentSaving)<br/>function DocumentSaving(args){<br/>return false;}<br/>">
                                                            </telerik:RadTreeNode>
                                                        </Nodes>
                                                    </telerik:RadTreeNode>
                                                </Nodes>
                                            ...
                                            <telerik:RadTreeNode Value="Erp.SaveContainer()" Text="SaveContainer" Info="Desc:Saves all the fields in the specified container panel.|Eg:Erp.SaveContainer('Panel-1')">
                                            </telerik:RadTreeNode>
                                            ...
                                            <telerik:RadTreeNode Value="Erp.ResetFields()"   Text="ResetFields" Info="Desc:Resets the value for all fields inside the specified container.|Eg:Erp.ResetFields('panel1');<br/>Erp.ResetFields();">
                                            </telerik:RadTreeNode>
                                            ...
                                            <telerik:RadTreeNode Value="Erp.CreateTable(tbl, cols, opt)" NoWF="1" Text="CreateTable" Info="Desc:Renders a html table for the specified table variable.|Eg:Erp.CreateTable(tbl1);<br/>Erp.CreateTable(tbl1,<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [{name: 'col1', title: 'col 1', width: 100,onCellRender:function(dr,col){ return '<a>'+dr[col]+'</a>';} , colCss: '', colStyle: '' },<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{name: 'col2', title: 'col 2', width: 100 }],<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{Id:'tbl123', container:'parentCtr', showSerial:false, tableCss:'', tableStyle:'', rowCss: '', altRowCss: '', rowStyle: '', altRowStyle: '' });|Result:An html table is created with default settings for the table variable tbl1<br/>An html table is created with id tbl123 with specified settings inside an element with id parentCtr.">
                                             ...
                                             <telerik:RadTreeNode Value="Erp.DataBind(id, data)" NoWF="1" Text="DataBind" Info='Desc:Databind controls like Menu or dropdown.|Eg:Erp.DataBind("Menu1",[{id:"1",pid:null,title:"1",tag:"asd",icon:"&#xf0f6;"},{id:"1.1",pid:"1",title:"1.1",count:"123"},{id:"2",pid:null,title:"2"}]);<br/>Erp.DataBind("select1",[{value:"1",text:"1"},{value:"2",text:"2"}]);'>
                                            </telerik:RadTreeNode>
                                            ...
                                            <telerik:RadTreeNode Value="Erp.SetLabel()" Text="SetLabel" Info="Desc:Sets the value of a label.|Eg:Erp.SetLabel('Label-1','Hello World');<br/>Erp.SetLabel('Label-1','Hello World',icon);">
                                            </telerik:RadTreeNode>
                                            ...
                                            <telerik:RadTreeNode Value="Erp.SetButtonLabel()" Text="SetButtonLabel" Info="Desc:Sets the label of a button.|Eg:Erp.SetButtonLabel('Button-1','Hello World');">
                                               ...
                                               <telerik:RadTreeNode Value="Erp.RefreshLabels('panel1')" Text="RefreshLabels" Info="Desc:Refreshes all labels that are linked to input fields and sets new value.|Eg: Erp.RefreshLabels('panel1');<br/> Erp.RefreshLabels();|Result:All labels inside Panel1 will be refreshed.<br/>All labels on the page will be refreshed">
                                            </telerik:RadTreeNode> 
                                            ...
                                            <telerik:RadTreeNode Value="Erp.ShowBusyMessage(msg)" Text="ShowBusyMessage" Info="Desc:Displays a message at the top of the screen and prevents user from interacting with the screen|Eg:Erp.ShowBusyMessage('Hello World');<br/>Erp.ShowBusyMessage('Hello World',false);<br/>Erp.ShowBusyMessage('Hello World','token123');|Result:A message is displayed at the top and user is prevented from data entry.<br/>The message is displayed but user interaction is also possible.<br/>If a token is provided then no other busy messages will be displayed on screen until this token is closed">
                                            </telerik:RadTreeNode>
                                            <telerik:RadTreeNode Value="Erp.HideBusyMessage()" Text="HideBusyMessage" Info="Desc:The busy message previously displayed is hidden.|Eg:Erp.HideBusyMessage();<br/>Erp.HideBusyMessage('token123');|Result:Busy message is closed.<br/>Busy message for the token is closed">
                                            </telerik:RadTreeNode>
                                            ...
                                            <telerik:RadTreeNode Value="Erp.ShowDialog(msg)" Text="ShowDialog" Info="Desc:A dialog box is shown to user with specified buttons.Additionaly a form id can be specified which will be displayed inside the popup|Eg:Erp.ShowDialog('Do you wish to delete?',[{label:'Yes',value:'btnYes',class:'btn-yes'},{label:'Cancel'}],function(cmd){});<br/>Erp.ShowDialog({title:'Take Action',message:'Do you wish to delete?',iconText:'&amp;#xf1f8;'},'Yes,No,Not_Sure',function(cmd){});<br/>Erp.ShowDialog({title:'Take Action',message:'Do you wish to delete?',iconText:'&amp;#xf1f8;'},'Yes,No,Not_Sure','div123',function(cmd){});<br/>Erp.ShowDialog({title:'Take Action',message:'Do you wish to delete?',iconText:'&amp;#xf1f8;'},'Yes,No,Not_Sure',$('<input id=&quot;txt123&quot;>'),function(cmd){});<br/>Erp.ShowDialog({<br/>&nbsp;&nbsp;&nbsp;&nbsp;id:&nbsp;null,&nbsp;<br/>&nbsp;&nbsp;&nbsp;&nbsp;class:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;title:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;titleColor:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;titleSize:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;titleLineHeight:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;message:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;messageColor:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;messageSize:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;messageLineHeight:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;backgroundColor:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;theme:&nbsp;'light',&nbsp;//&nbsp;dark,light<br/>&nbsp;&nbsp;&nbsp;&nbsp;color:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;icon:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;iconText:&nbsp;'&amp;#xf1f8;',<br/>&nbsp;&nbsp;&nbsp;&nbsp;iconColor:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;iconUrl:&nbsp;null,<br/>&nbsp;&nbsp;&nbsp;&nbsp;image:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;imageWidth:&nbsp;50,<br/>&nbsp;&nbsp;&nbsp;&nbsp;maxWidth:&nbsp;null,<br/>&nbsp;&nbsp;&nbsp;&nbsp;zindex:&nbsp;null,<br/>&nbsp;&nbsp;&nbsp;&nbsp;layout:&nbsp;1,//1&nbsp;:&nbsp;small,2&nbsp;:&nbsp;medium<br/>&nbsp;&nbsp;&nbsp;&nbsp;balloon:&nbsp;false,<br/>&nbsp;&nbsp;&nbsp;&nbsp;close:&nbsp;true,<br/>&nbsp;&nbsp;&nbsp;&nbsp;closeOnEscape:&nbsp;false,<br/>&nbsp;&nbsp;&nbsp;&nbsp;closeOnClick:&nbsp;false,<br/>&nbsp;&nbsp;&nbsp;&nbsp;displayMode:&nbsp;0,&nbsp;//&nbsp;0&nbsp;:&nbsp;default,1&nbsp;:&nbsp;once,2&nbsp;:&nbsp;replace<br/>&nbsp;&nbsp;&nbsp;&nbsp;position:&nbsp;'bottomRight',&nbsp;//&nbsp;bottomRight,&nbsp;bottomLeft,&nbsp;topRight,&nbsp;topLeft,&nbsp;topCenter,&nbsp;bottomCenter,&nbsp;center<br/>&nbsp;&nbsp;&nbsp;&nbsp;target:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;targetFirst:&nbsp;true,<br/>&nbsp;&nbsp;&nbsp;&nbsp;timeout:&nbsp;5000,//false&nbsp;to&nbsp;disable<br/>&nbsp;&nbsp;&nbsp;&nbsp;rtl:&nbsp;false,<br/>&nbsp;&nbsp;&nbsp;&nbsp;disableCloseTransition:&nbsp;false,<br/>&nbsp;&nbsp;&nbsp;&nbsp;drag:&nbsp;true,<br/>&nbsp;&nbsp;&nbsp;&nbsp;pauseOnHover:&nbsp;true,<br/>&nbsp;&nbsp;&nbsp;&nbsp;resetOnHover:&nbsp;false,<br/>&nbsp;&nbsp;&nbsp;&nbsp;progressBar:&nbsp;true,<br/>&nbsp;&nbsp;&nbsp;&nbsp;progressBarColor:&nbsp;'',<br/>&nbsp;&nbsp;&nbsp;&nbsp;progressBarEasing:&nbsp;'linear',<br/>&nbsp;&nbsp;&nbsp;&nbsp;overlay:&nbsp;false,<br/>&nbsp;&nbsp;&nbsp;&nbsp;overlayClose:&nbsp;false,<br/>&nbsp;&nbsp;&nbsp;&nbsp;overlayColor:&nbsp;'rgba(0,&nbsp;0,&nbsp;0,&nbsp;0.6)',<br/>&nbsp;&nbsp;&nbsp;&nbsp;transitionIn:&nbsp;'fadeInUp',//bounceInLeft,&nbsp;bounceInRight,&nbsp;bounceInUp,&nbsp;bounceInDown,&nbsp;fadeIn,&nbsp;fadeInDown,&nbsp;fadeInUp,&nbsp;fadeInLeft,&nbsp;fadeInRight,flipInX<br/>&nbsp;&nbsp;&nbsp;&nbsp;transitionOut:&nbsp;'fadeOut',//fadeOut,&nbsp;fadeOutUp,&nbsp;fadeOutDown,&nbsp;fadeOutLeft,&nbsp;fadeOutRight,&nbsp;flipOutX<br/>&nbsp;&nbsp;&nbsp;&nbsp;transitionInMobile:&nbsp;'fadeInUp',<br/>&nbsp;&nbsp;&nbsp;&nbsp;transitionOutMobile:&nbsp;'fadeOutDown',<br/>&nbsp;&nbsp;&nbsp;&nbsp;buttons:&nbsp;{},<br/>&nbsp;&nbsp;&nbsp;&nbsp;inputs:&nbsp;{},<br/>&nbsp;&nbsp;&nbsp;&nbsp;onOpening:&nbsp;function&nbsp;()&nbsp;{},<br/>&nbsp;&nbsp;&nbsp;&nbsp;onOpened:&nbsp;function&nbsp;()&nbsp;{},<br/>&nbsp;&nbsp;&nbsp;&nbsp;onClosing:&nbsp;function&nbsp;()&nbsp;{},<br/>&nbsp;&nbsp;&nbsp;&nbsp;onClosed:&nbsp;function&nbsp;()&nbsp;{}<br/>});">
                                            </telerik:RadTreeNode>
                                            <telerik:RadTreeNode Value="Erp.HideDialog(id)" Text="HideDialog" Info="Desc:Hides any dialog displayed  on screen.|Eg:Erp.HideDialog('msg-1');<br/>Erp.HideDialog('msg-1',{cmd:'abc',key1:'val1'});|Result:The dialog is closed<br/>The dialog is closed and the data object is passed to the onClosing and onClosed events">
                                            </telerik:RadTreeNode>
                                            ...
                                            <telerik:RadTreeNode Value="Erp.LoadVariable('var',function(){ });\n" Text="LoadVariable" Info="Desc:Reloads a previously declared variable of table or value type|Eg:Erp.LoadVariable('tbl123',function(){alert(tbl123);});<br/>Erp.LoadVariable(['tbl123','val1','val2'],function(){alert(val1);});<br/>Erp.LoadVariable('tbl123',{EnablePaging:true , CurrentPageIndex:1 , PageSize:30},function(){alert(tbl123);});|Result:The variable with name tbl123 is loaded and the specified callback function is executed after loading<br/>All the variables specified in the array is loaded<br/>Data will be fetched page wise.">
                                            </telerik:RadTreeNode>
                                             <telerik:RadTreeNode Value="Erp.LoadResource('/css/abc.css','css');\n" Text="LoadResource" Info="Desc:Loads a css or javascript resource file|Eg:Erp.LoadResource('/css/abc.css','css');<br/>Erp.LoadResource('/script/abc.js','script');<br/>Erp.LoadResource('/script/abc.js','script',function(){ alert('loaded');});<br/>|Result:The requested css file will be loaded<br/>The requested js file will be loaded<br/>The requested js file will be loaded and the callback function will be called after loading the file.">
                                            </telerik:RadTreeNode>
                                            ...
                                            <telerik:RadTreeNode Value="Erp.ServerCommand('cmd1', {}, dataOnly, function(cmd,args){alert(cmd);console.log(args);});\n" Text="ServerCommand" Info="Desc:Triggers a command which will execute a server script.Callback Function parameter args will contain the original args sent to server including any other properties set on server|Eg:Erp.ServerCommand('cmd1',{arg1:'1'},function(cmd,args){alert(cmd);console.log(args);});<br/>Erp.ServerCommand('cmd1',{arg1:'1'}, true, function(cmd,args){alert(cmd);console.log(args);});|Result:The command is executed. Entire page data is sent to server.<br/>The command is executed. No page data is sent to server.">
                                            </telerik:RadTreeNode>
                                    ...
                                    <telerik:RadTreeNode SS="1" Value="InterfaceFunctions" Text="Interface Functions">
                                        <Nodes>
                                            <telerik:RadTreeNode Value="" SS="1" Text="Grid" Info="Desc:Grid Related Functions">
                                                <Nodes>
                                                    ...
                                                    <telerik:RadTreeNode Value="object val = Erp.Grid.GetRecordValue(grid,colName,rowIndex);\n" NoWF="1" Text="GetRecordValue" Info="Desc:Gets the value in specified row and column.|Eg:object val = Erp.Grid.GetRecordValue('Grid-1','col123',1);">
                                                     ...
                                                     <telerik:RadTreeNode Value="string val=Erp.Grid.GetParamValue(grid,paramInd);\n" NoWF="1" Text="GetParamValue" Info="Desc:Gets the associated param value for the currently selected record/specified record.|Eg:Erp.Grid.GetParamValue('Grid-1',0);|Result:Gets the value for the first param  for currently selected row.">
                                                    </telerik:RadTreeNode>
                                                     <telerik:RadTreeNode Value="string[] ids = Erp.Grid.GetRecordID_Multiple(grid);\n" NoWF="1" Text="GetRecordID_Multiple" Info="Desc:Gets an array of record ids for all the selected records in the grid.|Eg:Erp.Grid.GetRecordID_Multiple('Grid-1');|Result:[1,2,5]">
                                                    </telerik:RadTreeNode>      
                                                     <telerik:RadTreeNode Value="object[] vals = Erp.Grid.GetRecordValue_Multiple(grid,colName);\n" NoWF="1" Text="GetRecordValue_Multiple" Info="Desc:Gets an array of record values for specified column for all the selected records in the grid.|Eg:Erp.Grid.GetRecordValue_Multiple('Grid-1','col1');|Result:['val1','val5']">
                                                    </telerik:RadTreeNode>                                                                               
                                                     <telerik:RadTreeNode Value="string[] paramVals = Erp.Grid.GetParamValue_Multiple(grid,paramInd);\n" NoWF="1" Text="GetParamValue_Multiple" Info="Desc:Gets an array of associated param values for all selected records.|Eg:Erp.Grid.GetParamValue_Multiple('Grid-1',0);|Result:['param1','param2','param5']">
                                                    </telerik:RadTreeNode>
                                                    <telerik:RadTreeNode Value="string[] arrFilter = Erp.Grid.GetRecordID_Filtered(grid);\n" NoWF="1" Text="GetRecordID_Filtered" Info="Desc:Gets an array of record ids for all the filtered records in the grid.|Eg:Erp.Grid.GetRecordID_Filtered('Grid-1');">
                                                    </telerik:RadTreeNode>                                                                                                  
                                                    <telerik:RadTreeNode Value="string[] arrFilterParam = Erp.Grid.GetParamValue_Filtered(grid,paramInd);\n" NoWF="1" Text="GetParamValue_Filtered" Info="Desc:Gets an array of associated param values for all filtered records.|Eg:Erp.Grid.GetParamValue_Filtered('Grid-1',0);">
                                                    </telerik:RadTreeNode> 

                                                     <telerik:RadTreeNode Value='string[] ids = Erp.Grid.GetActualRecords((object[])args["selection"]);\n' NoWF="1" Text="GetActualRecords" Info="Desc:Gets an array of record ids for all the selected records in the grid.|Eg:Erp.Grid.GetActualRecords((object[])args['selection']);|Result:[1,2,5]">
                                                    </telerik:RadTreeNode> 
                                                    <telerik:RadTreeNode Value='string sql = Erp.Grid.GetActualRecordsSql((object[])args["selection"]);\n' NoWF="1" Text="GetActualRecordsSql" Info="Desc:Gets the sql for the filtered records in the grid.|Eg:Erp.Grid.GetActualRecordsSql((object[])args['selection']);|Result:[1,2,5]">
                                                    </telerik:RadTreeNode>        
                                                    ...
                                                    <telerik:RadTreeNode Value="string[] columns = Erp.Grid.GetColumns(grid);\n" NoWF="1" Text="GetColumns" Info="Desc:Gets list of serialized columns.|Eg:string[] columns=Erp.Grid.GetColumns('Grid-1');">
                                                     ...
                                                     <telerik:RadTreeNode Value="bool selected = Erp.Grid.GetRecordSelected(grid,rowIndex);\n" NoWF="1" Text="GetRecordSelected" Info="Desc:Return true if the row is selected.|Eg:string state = Erp.Grid.GetRecordSelected('Grid-1',1);">
                                                    </telerik:RadTreeNode>     
                                            ...
                                            <telerik:RadTreeNode Value="Erp.RedirectToError(title,description);" Text="RedirectToError" Info='Desc:Page is redirected to error page with specified title and description|Eg:Erp.RedirectToError("Error","There was an error while processing the request");'>
                                            </telerik:RadTreeNode>
                                            <telerik:RadTreeNode Value='Erp.ExecuteTask(new Dictionary<string, object>() { \n  { "TaskID", "123" }, \n  { "RecordID", "456" }, \n  { "EntityID", "tbl_Core_Company" } , \n  { "Arg1", 789 }\n});\n' Text="ExecuteTask" Info="Desc:Executes the specified Task with provided arguments. <a href='javascript:void(0)' onclick='OpenUrlEditor(1)'  style='font-size: 14px;font-family: nunitoregular;color: #07F;' >Get Task ID</a><br/>Result is an object with following structure<br/>{ Success:true/false, Exception:true/false, ExceptionMessage:'', WorkflowCompleted:true/false, WorkflowSucceded:true/false, Message:'' }">
                                             ...
                                             <telerik:RadTreeNode Value='string err="";\nvar dt=Erp.GetPagedData("select <# companycode,companyname #> from tbl_Core_Company #JOIN#  where company_pid=@ID #FILTER# #SORT# order by companyname",\n               new Dictionary<string, object>() { \n                 { "@ID", "123" }\n               }, 0, 30, out err);\n' Text="GetPagedData" Info='Desc:This method will return data from the specified index.|Eg:var dt=Erp.GetPagedData("select <# companycode,companyname #> from tbl_Core_Company #JOIN#  where company_pid=@ID #FILTER# #SORT# order by companyname",<br/>                          new Dictionary<string, object>() { <br/>                            { "@ID", 1 }<br/>                          }, 2, 30, out err);|Result: 30 records will be retrieved starting from page index 2. so rows 61 to 90 will be retrieved'>
                                            </telerik:RadTreeNode>
                                            ...
                                            <telerik:RadTreeNode Value="Erp.RaiseNotification({...});\n" Text="RaiseNotification" Info='Desc:Raises a notification with provided arguments. <a href="javascript:void(0)" onclick="OpenUrlEditor(3)"  style="font-size: 14px;font-family: nunitoregular;color: #07F;" >Notification Settings</a>|Eg:Erp.RaiseNotification(new Dictionary<string, object>() {<br/>      {"UserID","u1,u2,u3"},<br/>      {"RecordID","rec1,rec2"},<br/>      {"TemplateID","1"},<br/>      {"EntityID","tbl_CORE_company"},<br/>      {"NotificationTitle","[Field.field1] [ReceiverUser.field1]"},<br/>      {"NotificationMessage","<p>[Field.Field1]</p><p>[Field.field2]<br>"},<br/>      {"NotificationImage","[ReceiverUser.profileimage]"},<br/>      {"NotificationIcon","&#xf010;"},<br/>      {"NotificationAction",""},<br/>      {"DisplayDate",""},<br/>      {"TriggerDate",""},<br/>      {"EnableMobile","0"},<br/>      {"FcmApiKey",""}<br/>      {"UserVariables","Entity1:tbl_SYS_Users:123&#166;Entity2:tbl_CORE_Company:456"},<br/>      {"ForceSend",false});'>
                                            </telerik:RadTreeNode>
                                            <telerik:RadTreeNode Value="Erp.SendMail({...});\n" Text="SendMail" Info='Desc:Sends email with provided arguments.|Eg:Erp.SendMail(new Dictionary<string, object>() {<br/>      {"UserID","u1,u2,u3"},<br/>      {"RecordID","rec1,rec2"},<br/>      {"EmailConfigID","1"},<br/>      {"EmailConfigCode","1"},<br/>      {"DefaultConfig","0"},<br/>      {"SystemConfig","0"},<br/>      {"EntityID","tbl_CORE_company"},<br/>      {"TemplateID","123"},<br/>      {"EmailSubject","[Field.field1] [ReceiverUser.field1]"},<br/>      {"EmailBody","<p>[Field.Field1]</p><p>[Field.field2]<br>"},<br/>      {"EmailFrom","a@b.c"},<br/>      {"EmailFromDisplayName","A B"},<br/>      {"EmailReplyTo","x@y.z"},<br/>      {"EmailTo","z@x.c,[ReceiverUser.email],[Field.email]"},<br/>      {"EmailCc",""},<br/>      {"EmailBcc",""},<br/>      {"UserVariables","Entity1:tbl_SYS_Users:123&#166;Entity2:tbl_CORE_Company:456"},<br/>      {"ForceSend",false});'>
                                            </telerik:RadTreeNode>
                                             <telerik:RadTreeNode Value="Erp.SendSMS({...});\n" Text="SendSMS" Info='Desc:Sends SMS with provided arguments.|Eg:Erp.SendSMS(new Dictionary<string, object>() {<br/>      {"MobileNo","9123465677,812345678"},<br/>      {"EntityID","tbl_sys_users"},<br/>      {"RecordID","rec1"},<br/>     {"CfgCode","123"},<br/>      {"CfgID","1"},<br/>  );'>
                                            </telerik:RadTreeNode>
                                            ...
                                            <telerik:RadTreeNode Value='Erp.SetCookieData("key","value");' NoWF="1" Text="SetCookieData" Info='Desc:Set the value for the specified key in Cookie.|Eg:Erp.SetCookieData("key","123");<br/>Erp.SetCookieData("key","123",true);<br/>|Result:Non expiring cookie is created<br/>Cookie is created but will get destroyed on logout'>
                                            </telerik:RadTreeNode>
                                            <telerik:RadTreeNode Value='Erp.GetCookieData("key");' NoWF="1" Text="GetCookieData" Info='Desc:Retrieves value from Cookie for given key.|Eg:Erp.GetCookieData("key");'>
                                            </telerik:RadTreeNode>
                                             <telerik:RadTreeNode Value='Erp.RemoveCookie("key");' NoWF="1" Text="RemoveCookie" Info='Desc:Removes the Cookie.|Eg:Erp.RemoveCookie("key");'>
                                            </telerik:RadTreeNode>
                                            ...
                                            <telerik:RadTreeNode Value='Exec.aspx' Text="Exec.aspx" Info='Desc:Exec.aspx performs wf task,executes scripts based on passed in url parameters.|Eg:~/main/exec.aspx?_wid=123&_opt=1&_tsid=123&_esid=123&_nsc=1&_tmpauth=123<br/><br/>_wid = The workflow task to be executed<br/>_esid = server script to be executed<br/>_tsid = task script to be executed<br/>_nsc = 0 or 1 whether js and css resources need to be served<br/>_opt = 0 or 1 whether Message property from task script or WF is to be printed out in response<br/>_tmpauth = temporary authentication rights<br/>'>
                                            </telerik:RadTreeNode>
                                         </Nodes>
                                        </telerik:RadTreeNode>
                                    <telerik:RadTreeNode SS="0"  Value="InterfaceEvents" Text="Interface Events">
...
&lt;import:959319a7-cd3c-4f5e-ad13-93a5d23697ee&gt;, rename_namespace(oldspace, newspace);
    ...
    <script>
        ...
        function InitEditor() {
            ...
            if ($.QS("p") == "1" && $.QS("resmode") != "cscript") {
                VariablesList = parent.VariablesList;
                scriptEditor.setValue(parent.$("#divScript").find(".txtScript").val());
            }
            else if ($.QS("p") == "1" && $.QS("resmode") == "cscript") {
                VariablesList = parent.VariablesList;
                scriptEditor.setValue(parent.$("#divCScript").find(".txtScript").val());
            }
            else if ($.QS("ss") == "1") {
        ...
        function implScript(t) {
            if (t == "R")
                ...
                scr = '\npublic class MergeLetterScript : ImplLetterScript, ILetterScript\n    {\n        #region ILetterScript Members\n        public void Init(ApplicationInfo app, IDBConfiguration cfg)\n        {\n        }\n        public void Init(ApplicationInfo app, IDBConfiguration cfg, Dictionary<string, object> letterInfo, Dictionary<string, object> userData)\n        {\n        }\n        public void Init(ApplicationInfo app, IDBConfiguration cfg, Dictionary<string, object> letterInfo, Dictionary<string, object> userData, RichEditDocumentServer doc)\n        {\n        }\n        public List<string> GetVariableList()\n        {\n            //return new List<string>() { "var123","var456"};\n            return null;\n        }\n        public void BeforeReplaceTokens(ref string subject, ref string body, string recordId, string userId, Dictionary<string, object> userData)\n        {\n            //body = body.Replace("{var456}", "a&b");\n        }\n        public void AfterReplaceTokens(ref string subject, ref string body, string recordId, string userId, Dictionary<string, object> userData)\n        {\n        }\n        public void OnReplaceDocVariables(object sender, CalculateDocumentVariableEventArgs args)\n        {\n        }\n        public Dictionary<String, object> Callback(Dictionary<string, object> data)\n        {\n            return data;\n        }\n        #endregion\n    }\n';
